...
import com.sai.hackbandung.Adapter.MyAdapterGovernment_Completed;
...
public class CompletedReportsGovernment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        // menambahkan layout
        v = inflater.inflate(R.layout.completed_reports_government, container, false);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    ...
                    if (RI.responsibleAgency.equals(responsibleAgencyFromNAVDRAWERGOVERNMENT) && RI.status.equals("completed")) {
                        reportInfos.add(RI);
                    }
                }

                //creating adapter
                adapterCompleted = new MyAdapterGovernment_Completed(getActivity().getApplicationContext(), reportInfos);
