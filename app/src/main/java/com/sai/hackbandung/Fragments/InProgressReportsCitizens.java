...
public class InProgressReportsCitizens extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        ...
        // menambahkan layout
        v = inflater.inflate(R.layout.in_progress_reports_citizens, container, false);

        recyclerView = (RecyclerView) v.findViewById(R.id.recyclerViewWIP);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    ...
                    if (RI.username.equals(usernameFromNAVDRAWCITIZENS) && RI.status.equals("wip")) {
                        reportInfos.add(RI);
                    }
                }
